				...
				<form method="POST" action='<?php echo site_url(' admin/save_new_sliderimage')?>'> <div class="box-body pad">
					...
					<div class="input-group">
						<input type="text" class="form-control" placeholder="Recipient's username" aria-describedby="basic-addon2" name='image'
						 id="image_link">
						<span style="background: #009fff;color: white;" class=" btn btn-primary input-group-addon" role='button' id="basic-addon2"
						 data-toggle="modal" data-target="#myModal">upload</span>
					</div>
